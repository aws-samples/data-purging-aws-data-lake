...
--------------------------------------------
This can be a simpler way of implementation, where you are relying in AWS tagging feature to capture additional metadata and use that for purging. This option might have limitations as you miss the flexibility of customizing Metastore as per your need. But still customers can choose this, if they feel creating custom Metastore adds complexity and they can live with the tag values. But they need to consider limitations like maximum tags they can add per object, exposing customer ID or other information as part of tag value and custom solution to query or filter objects by tags.
...
- Elasticsearch: Great for searching through indexes and getting ad hoc reports with Kibana
...
Please do let us know your feedback in comments and how did you really implement it in your organization, so that other customers can learn from it. Happy Learning!
